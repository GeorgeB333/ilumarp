...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,400..800;1,400..800&family=Oswald:wght@400..700&family=Roboto+Mono:wght@400;500&family=Tilt+Warp&family=Unbounded:wght@800&display=swap",
      },
    ],
  }),
